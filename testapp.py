...
# --- Configuration ---
MODEL_PATH = 'facetrackercpu.h5'

# --- App Branding and Page Setup ---
...
st.markdown("<p style='text-align: center;'>Webcam-based face detection powered by your custom ML model!</p>", unsafe_allow_html=True)
...
def load_model():
    try:
        model = tf.keras.models.load_model(MODEL_PATH, compile=False)  # compile=False for inference only
        return model
...
# --- App State (start/stop streaming) ---
...
class FaceDetectionProcessor(VideoProcessorBase):
    def recv(self, frame):
        ...
        try:
            ...
            if yhat[0][0] > 0.5:
                # Scale bbox to match crop region in original image
            ...
            # Optionally log or display prediction errors
            pass
